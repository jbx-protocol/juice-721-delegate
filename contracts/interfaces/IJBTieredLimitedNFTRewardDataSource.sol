...
interface IJBTieredLimitedNFTRewardDataSource {
  ...
  function trackVotingUnits(uint256 _tierId) external view returns (bool);

  function balanceInTierOf(address _account, uint256 _tier) external view returns (uint256);
